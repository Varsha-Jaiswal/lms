...
<?php
	if($_POST){
		...
		$query ="INSERT INTO author_data (AUTHOR_NAME) VALUES ('$auth_name')";
                 if (mysqli_query($db, $query)) {
                            $msg="New Author Successfully Added";
                         ...
                         //echo "Error updating record: " . mysqli_error($db);
                          ...
                          <a href='/lms2/addAuth'><button>Go Back</button></a> 
                          </div></center>";
                            echo "<center>";
...
<div class="container animated fadeInUp">
    <div class="row">
        <div class="col-md-6" style="background-color:;">
            <h4 style="margin-top:0%;margin-bottom:0px"><i class="fa fa-calendar-plus-o animated fadeInDown" aria-hidden="true"></i> Add Author</h4>
        ...
        <div class="col-md-12" style="">
            <ul class="list-inline" style="margin:0px">
                <li class="list-inline-item">
                    <a href="/lms2/showAuthor" class="btn btn-default btn-sm" style="margin:0px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to Manage Author</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="container z-depth-3" style="background-color:#fafafa ">
                <div class="row">
                    ...
                    <div class="col-md-7" style="background-color:#fafafa ">
                        ...
                        <div class="container">
                            <form action="/lms2/addAuth" method="post" style="background-color:;padding:0%">
                            <div class="row">
                                <div class="col-md-12">
                                    <form-group>
                                            <label style="">Author Name</label>
                                            <input style="" type="text" placeholder="Enter Book Category Name" name="auth_name">
                                    </form-group>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn btn-info" type="submit" style="margin-left:0px;margin-top:5%;" name="submit">Save Author</button>
                                </div>
                            </div>
                            </form>
                        </div>
