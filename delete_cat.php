...
$sql = "DELETE FROM book_cat WHERE BC_ID=$a";

if (mysqli_query($db, $sql)) {
    $msg="Book Category has been Delected Successfully";
    echo "Record deleted successfully";
   ...
   <center> Error deleting record!! " // mysqli_error($db)
    ...
    <a href='/lms2/showcat'><button>Go Back</button></a>
    </center>
...
<html>
    <head>
    <title>Deleating Category...</title>
