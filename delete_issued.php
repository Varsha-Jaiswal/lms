...
$sql = "DELETE FROM issue_data WHERE ISSUE_ID=$a";

if (mysqli_query($db, $sql)) {
        $sql = "UPDATE book_data SET B_STAUS=1 WHERE B_ID=$BID";
        if ($db->query($sql) === TRUE) {
            ...
            exit;
               ...
               <center> Error deleting record!! " // mysqli_error($db)
                ...
                <a href='/lms2/showissue'><button>Go Back</button></a>
                </center>
...
<html>
    <head>
    <title>Deleating Issued Book...</title>
