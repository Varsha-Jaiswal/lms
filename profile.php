       ...
       // error_reporting(0);
		...
		$query="UPDATE `admin_data` SET `ad_fname`='$username',`ad_lname`='$last_name',`ad_email`='$email' WHERE ad_id=$id";
                 if (mysqli_query($db, $query)) {
                            ...
                            echo $msg;
                            header('Location: /lms2/profile/'.urlencode($msg).'');
                            exit;
                } 
                else{
                         //echo "Error updating record: " . mysqli_error($db);
                          ...
                          <a href='/lms2/profile'><button>Go Back</button></a> 
                          </div></center>";
                            echo "<center>";
...
error_reporting(0);
	...
	if (!empty($_POST['submit-pass']))
    {
        ...
        if($new_pass==$confirm_pass)
        {
            ...
            $query ="SELECT ad_id FROM admin_data where ad_password='$current_pass'";
            ...
            if($result = $db->query($query)){
                ...
                {       $new_pass =md5(mysqli_real_escape_string($db,stripslashes($_POST['npass'])));
                        $query = "UPDATE admin_data SET ad_password='$new_pass' WHERE ad_id=$id";
                        if (mysqli_query($db, $query)) {
...
<head>
    ...
    <title>Manage Profile | LMS</title>
...
<div class="container animated fadeInUp">
    <div class="row">
        <div class="col-md-12" style="">
            <div class="container z-depth-3" style="background-color:#1a237e">
                <div class="row">
                    ...
                    <div class="col-md-3 z-depth-3" style="padding:2%;background-color:#cfd8dc">
                        ...
                        <center><h4 style=""><?php echo $login_user." ".$lname; ?></h4></center>
                         ...
                         <hr>
                        <button style="margin-left:0px;color:white" type="button" class="btn btn-block btn-sm btn-info waves-effect active" id="perb"><i class="fa fa-user left"></i> Personal Setting</button>
                                    
                        <button style="margin-left:0px;color:white" id="chgpass" type="button" class="btn btn-block btn-sm btn-info waves-effect"><i class="fa fa-lock left"></i> Change Password</button>
                        <br>
                        <hr>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="container">
                            <div class="row">
                                <!--       Personal Setting    -->
                                <div class="col-md-12" style="margin-top:3%;margin-bottom:2%;background-color:;color:white" id="section_per">
                                    <div class="container">
                                       <form method="post" action="/lms2/profile">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-md-offset-2" style="padding:.5%">
                                                <p style="font-size:12px;color:white;margin:0px">
                                                    <b>Username :</b></p>
                                ...
                                <!--       Password Setting    -->
                                <div class="col-md-12" style="margin-top:2%;color:white" id="section_pass">
                                    <div class="container">
                                       <form method="post" action="/lms2/profile" >
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-md-offset-2" style="padding:.5%">
                                                    <p style="font-size:12px;color:#880e4f;margin:0px;color:white">
